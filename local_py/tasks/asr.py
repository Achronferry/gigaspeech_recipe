...
from local_py.asr.espnet_model import ESPnetASRModel
...
class ASRTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            "--rnnt_conf",
            action=NestedDictAction,
            default=get_default_kwargs(RNNT),
    ...
    def build_model(cls, args: argparse.Namespace) -> ESPnetASRModel:
        ...
        from local_py.nets_esp1.transducer import RNNT
        rnnt_decoder = RNNT(
            odim=vocab_size, encoder_output_size=encoder.output_size(), **args.rnnt_conf
        )
