...
from espnet2.nets.transducer.blocks import build_blocks
from espnet2.nets.transducer.utils import check_batch_states
from espnet2.nets.transducer.utils import check_state
from espnet2.nets.transducer.utils import pad_sequence
...
class CustomDecoder(ScorerInterface, torch.nn.Module):
