        ...
        if distributed_option.distributed:
            if args.batch_per_gpu:
                if distributed_option.dist_rank == 0:
                    logging.warning(f"!!!WARNING!!! batch_size will be multiply by world_size {distributed_option.dist_world_size}")
                if args.batch_size is not None:
                    args.batch_size = args.batch_size * distributed_option.dist_world_size
                if args.batch_bins:
                    args.batch_bins = args.batch_bins * distributed_option.dist_world_size
